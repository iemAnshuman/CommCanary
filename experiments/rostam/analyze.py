#!/usr/bin/env python3
"""Analyze Rostam physical experiment result JSON files."""
...
def render_markdown(analysis: Mapping[str, Any]) -> str:
    ...
    lines.append(
        f"Baseline: `{regression.get('baseline_config')}`; candidate: `{regression.get('candidate_config')}`."
    )
