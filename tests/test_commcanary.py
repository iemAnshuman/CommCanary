...
class CommCanaryTests(unittest.TestCase):
    ...
    def test_ddmin_reduction_preserves_configuration_rankings(self):
        ...
        self.assertIn("Not source-verified", reduced["workload"]["notes"].replace("not source-verified", "Not source-verified"))
    ...
    def test_param_export_compute_fill_converts_gaps_to_gemm_entries(self):
        ...
        entries = canary_to_param_comms_trace(
            canary, compute_fill_us_per_gemm=10.0, compute_fill_gemm_dim=512
        )
    ...
    def test_param_export_overlap_structure_interleaves_issue_gemm_wait(self):
        ...
        kinds = [
            "gemm" if e.get("compute") == "gemm" else e.get("comms") for e in entries
        ]
